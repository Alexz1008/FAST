	  ...
	  <div className="navbar-right">
		<div className = "navbar-search">
		  <form action='/home'>
			...
			<button type="submit" className = "navbar-search-button"><img src="https://cdn1.iconfinder.com/data/icons/hawcons/32/698627-icon-111-search-512.png" alt="Search" height = "30" width = "30"/></button>
		  </form>
		</div>
